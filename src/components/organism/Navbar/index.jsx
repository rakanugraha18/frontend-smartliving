...
import { FiLogOut } from "react-icons/fi"; // Impor ikon logout
...
import { useAuth } from "../../../context/authContext"; // Impor konteks autentikasi
            ...
            {isLoggedIn && (
              <div className="text-center md:block group">
                <button onClick={handleLogout}>
                  <FiLogOut
                    className="text-red-500  text-base mx-auto group-hover:text-[#167a69]"
                    size={24}
                  />
                  <span className="text-[10px] text-red-500 hidden md:block pt-3 group-hover:text-[#167a69]">
                    Logout
                  </span>
                </button>
              </div>
